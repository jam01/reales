...
import io.github.jam01.rea.conversion.Consume;
...
public class FConsume extends Consume {
    private final Map<String, Attribute<?>> attributes;
    private final Function<FConsume, Void> invariants;

    public FConsume(Resource resource,
                    Map<String, Attribute<?>> attributes,
                    Function<FConsume, Void> invariants) {
        super(resource);
